...
fun LoginScreen(
    ...
    val annotatedString = buildAnnotatedString {
        withStyle(style = SpanStyle(color = MaterialTheme.colorScheme.primary)) {
            pushStringAnnotation(tag = RESET_ROUTE, annotation = RESET_ROUTE)
    ...
    LaunchedEffect(viewModel.isLoggedIn) {
        if (viewModel.isLoggedIn) onFinish()
    }
        ...
        item {
            ...
            if (viewModel.isLoading) {
                ...
                AuthField(
                    ...
                    onUpdate = viewModel::onPasswordChange,
                ...
                OutlinedButton(
                    onClick = {
                        openScreen(SIGN_UP_ROUTE, true)
                    }, modifier = Modifier
                        .padding(10.dp)
                        .fillMaxWidth()
                ) {
                    Text(text = stringResource(id = R.string.noAccount))
                }
            }
        }
    }
